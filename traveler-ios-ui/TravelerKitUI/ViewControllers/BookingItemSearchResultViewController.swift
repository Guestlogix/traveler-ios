...
class BookingItemSearchResultViewController: UIViewController {
    ...
    private var selectedCatalogItem: ProductItem?
...
extension BookingItemQuery {
    ...
    init(page: Int, for query: BookingItemQuery) {
        self.init(offset: page * BookingItemQuery.pageSize, take: query.limit, text: query.text, range: query.range, categories: query.categories, boundingBox: query.boundingBox)
    }
}
