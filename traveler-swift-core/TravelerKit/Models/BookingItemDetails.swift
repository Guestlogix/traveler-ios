...
public struct BookingItemDetails: CatalogItemDetails, Product, Decodable {
    /// Identifier
    ...
    enum CodingKeys: String, CodingKey {
            ...
            case disclaimer
            case googleTranslateAttribution
        }
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.translateAttribution = try container.decode(GoogleTranslateAttribution.self, forKey: .googleTranslateAttribution)
    }
}
