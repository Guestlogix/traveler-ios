...
public struct ParkingItemDetails: CatalogItemDetails, Product, Decodable {
    /// Description
    ...
    public let paybleOnline: Price
    /// Amount to be paid on site
    public let payableOnSite: Price
    /// Translate attribution
    public let translateAttribution: GoogleTranslateAttribution
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.paybleOnline = try container.decode(Price.self, forKey: .payableOnline)
        self.payableOnSite = try container.decode(Price.self, forKey: .payableOnSite)
        ...
        self.translateAttribution = try container.decode(GoogleTranslateAttribution.self, forKey: .googleTranslateAttrbution)
    }
